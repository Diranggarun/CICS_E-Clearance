        ...
        <section className="flex min-w-0 flex-col items-center justify-center">
          <section className="flex min-h-[640px] w-full max-w-[430px] flex-col justify-center rounded-[30px] border border-[#dbe7ff] bg-white px-9 py-12 shadow-[0_10px_32px_rgba(13,39,247,0.08),inset_0_1px_0_rgba(255,255,255,0.9),inset_0_-10px_24px_rgba(13,39,247,0.025)] ring-1 ring-white/80">
            <div className="mb-10 text-center">
              ...
              <h2 className="bg-gradient-to-b from-[#0D27F7] to-[#0E1BEF] bg-clip-text text-3xl font-bold text-transparent">
                Sign in
              </h2>

              <p className="mt-2 text-sm font-medium text-gray-500">
                Access your clearance portal.
              </p>
            </div>
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-[12px] border border-[#dbe7ff] bg-white px-4 pl-11 text-sm text-gray-700 outline-none transition placeholder:text-gray-400 focus:border-[#0D27F7] focus:ring-4 focus:ring-[#0D27F7]/15"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-[12px] border border-[#dbe7ff] bg-white px-4 pl-11 pr-12 text-sm text-gray-700 outline-none transition placeholder:text-gray-400 focus:border-[#0D27F7] focus:ring-4 focus:ring-[#0D27F7]/15"
                  />
              ...
              <div className="flex justify-end">
                <Link
                  to="/forgot-password"
                  className="text-xs font-medium text-[#1767FE] underline-offset-4 transition hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="h-12 rounded-full bg-gradient-to-b from-[#0D27F7] to-[#0E1BEF] text-sm font-semibold text-white shadow-[0_8px_24px_rgba(13,39,247,0.2)] transition hover:opacity-95 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
              >
            ...
            <div className="mt-8 border-t border-[#e2ebff] pt-6">
              <p className="text-center text-sm font-medium text-gray-500">
                ...
                <Link
                  to="/register"
                  className="font-semibold text-[#1767FE] transition hover:underline"
                >
                  Create one
                </Link>
              </p>
          ...
          <div className="relative z-10 flex w-full max-w-[500px] flex-col items-center gap-5 text-center">
            ...
            <div>
              ...
              <p className="mx-auto mt-3 max-w-[410px] text-sm font-medium leading-6 text-white/85">
                Complete your clearance digitally. Track every step from your
                device without visiting multiple offices.
              </p>
            </div>
            ...
            <div className="flex w-full max-w-[400px] flex-col gap-3">
              {FEATURES.map((feature) => (
                <article
                  key={feature.title}
                  className="flex min-h-[64px] items-center gap-3 rounded-2xl border border-white/45 bg-white/10 p-3.5 text-left shadow-[inset_0_0_16px_rgba(255,255,255,0.10)] backdrop-blur-sm transition hover:bg-white/15"
                >
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white text-lg text-[#0D27F7] shadow-sm">
                    {feature.icon}
                  </span>
